...
│   └── TCF_Strategic_Dashboard_Tables.xlsx # Excel tables for BI tools
...
4. **Run the dashboard**
   ...
   Or manually:
   ```bash
   streamlit run src/tcf_strategic_dashboard.py --server.port 8501
   ```
...
2. Run `python scripts/run_dashboard.py` or `streamlit run src/tcf_strategic_dashboard.py`
3. Open browser to the provided URL
4. Navigate through different sections using the sidebar

### Using Excel Tables
1. Open `data/TCF_Strategic_Dashboard_Tables.xlsx`
...
4. Reference `docs/EXCEL_TABLES_GUIDE.md` for detailed instructions
